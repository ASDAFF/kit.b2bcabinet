...
$buyers = [];
$pt = unserialize(Bitrix\Main\Config\Option::get("kit.b2bcabinet","BUYER_PERSONAL_TYPE","a:0:{}"));
if(!is_array($pt))
{
	$pt = [];
}
...
$orgProps = unserialize(Bitrix\Main\Config\Option::get('kit.b2bcabinet', 'PROFILE_ORG_NAME'));
