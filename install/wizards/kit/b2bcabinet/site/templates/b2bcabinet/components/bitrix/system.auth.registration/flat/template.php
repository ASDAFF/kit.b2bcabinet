...
if (\Bitrix\Main\Loader::includeModule("kit.auth")
    ...
    "kit:kit.auth.wholesaler.register",
    "b2bcabinet",
        [
            "AUTH" => "Y",
            ...
            "SHOW_WHOLESALER_FIELDS" => unserialize(Option::get('kit.b2bcabinet', 'OPT_REGISTER_FIELDS', '')),
            "SHOW_WHOLESALER_ORDER_FIELDS" => unserialize(Option::get('kit.b2bcabinet', 'OPT_REGISTER_ORDER_FIELDS', '')),
            "SUCCESS_PAGE" => "/",
            "USER_PROPERTY" => [
                'UF_CONFIDENTIAL'
            ],
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="form-group form-group-feedback form-group-feedback-left">
                                    ...
                                    <span class="form-text text-danger"><i class="icon-cancel-circle2 mr-2"></i> ����� ��� ����������</span>
                                </div>
