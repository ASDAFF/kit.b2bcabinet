...
use Kit\B2bCabinet\Helper\Prop;
        ...
        <div class="quick-view__content">
            <div class="quick-view__aside aside-block">
                ...
                <?if(!$arResult['haveOffers']):?>
                    ...
                    <div class="aside-block__price-wrap price-wrap">
                        <?if (Bitrix\Main\Loader::includeModule( "kit.privateprice" ) && Bitrix\Main\Loader::includeModule( "currency" )):
                            $privatePrice = KitPrivatePriceMain::setPlaceholder($arResult['ID'], $price['PRINT_PRICE']);?>
                ...
                <?if(!empty($arResult['minPrice'])):?>
                    <div class="aside-block__price-wrap price-wrap">
                        <?if (Bitrix\Main\Loader::includeModule( "kit.privateprice" ) && Bitrix\Main\Loader::includeModule( "currency" )):
                            $privatePrice = KitPrivatePriceMain::setPlaceholder($arResult['ID'], $arResult['minPriceFormat']);?>
