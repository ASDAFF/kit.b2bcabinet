...
$methodIstall = Option::get('kit.b2bcabinet', 'method_install', '', SITE_ID) == 'AS_TEMPLATE' ?
    SITE_DIR.'b2bcabinet/' :
    SITE_DIR;

$kitBillLink = $protocol . $_SERVER['SERVER_NAME'] . $methodIstall;
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body bg-light mb-0">
                                                    <dl class="row mb-0 payment-wrapper">
                                                        ...
                                                        <?if($arResult['PAY_SYSTEM']['ACTION_FILE'] == 'billkit'):?>
                                                            <dt class="col-sm-3">
                                                    ...
                                                    <dt class="col-sm-12 sale-order-detail-payment-options-methods-info">
                                                        <button
