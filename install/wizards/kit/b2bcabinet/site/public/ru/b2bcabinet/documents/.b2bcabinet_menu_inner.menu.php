<?php
use Kit\B2bCabinet\Helper\{Config, Document};
...
/*$aMenuLinksExt = $APPLICATION->IncludeComponent("bitrix:menu.sections","",Array(
		...
		"IBLOCK_TYPE" => Option::get("kit.b2bcabinet", "DOCUMENT_IBLOCK_TYPE", ""),
		"IBLOCK_ID" => Option::get("kit.b2bcabinet", "DOCUMENT_IBLOCK_ID", ""),
		"DEPTH_LEVEL" => "2",
		"CACHE_TYPE" => "A",
		"CACHE_TIME" => "3600"
	)
