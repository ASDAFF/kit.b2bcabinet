...
if(COption::GetOptionString("kit.b2bcabinet", "wizard_installed", "N", WIZARD_SITE_ID) != "Y")
{
    $locationGroupID = 0;
    $arLocationArr = Array();
    ...
    if(!$dlvBySiteExist)
    {
		...
		$fid = CFile::SaveFile($arPicture,'kit_b2bcabinet');
...
COption::SetOptionString("kit.b2bcabinet", "wizard_installed", "Y", false, WIZARD_SITE_ID);
