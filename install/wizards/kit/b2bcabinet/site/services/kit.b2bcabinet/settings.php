...
if(CModule::includeModule('kit.bill')) {
    $arPaySystems[] = array(
        'PAYSYSTEM' => array(
    ...
    $billLogo = $_SERVER['DOCUMENT_ROOT'] . '/bitrix/images/sale/sale_payments/billkit.png';
