...
if(IsModuleInstalled('kit.b2bshop') && (file_exists($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/kit.b2bshop/") || file_exists($_SERVER["DOCUMENT_ROOT"]."/bitrix/wizards/kit/b2bshop/"))) {
    ...
    Option::Set($moduleName, 'IBLOCK_TYPE', \Kit\Origami\Helper\Config::get('IBLOCK_TYPE'), WIZARD_SITE_ID);
    Option::Set($moduleName, 'IBLOCK_ID', \Kit\Origami\Helper\Config::get('IBLOCK_ID'), WIZARD_SITE_ID);
...
//catalog iblock import
    ...
    $iblockCode = "kit_b2bcabinet_catalog_" . WIZARD_SITE_ID;
    $iblockType = "kit_b2bcabinet_type_catalog";
    $iblockXMLID = 'kit_b2bcabinet_catalog_' . WIZARD_SITE_ID;
    ...
    if($IBLOCK_CATALOG_ID) {
        Option::Set($moduleName, 'CATALOG_IBLOCK_TYPE', $iblockType, WIZARD_SITE_ID);
        Option::Set($moduleName, 'CATALOG_IBLOCK_ID', $IBLOCK_CATALOG_ID, WIZARD_SITE_ID);
    }
