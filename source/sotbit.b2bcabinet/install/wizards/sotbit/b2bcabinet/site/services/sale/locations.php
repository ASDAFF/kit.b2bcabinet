...
if($bRus || COption::GetOptionString("sotbit.b2bcabinet", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA)
{
    //TODO -- need add parameter or set param: country_name.csv or full path name O_O
    ...
    if(strlen($loc_file) > 0)
    {
        ...
        if(\Bitrix\Main\Config\Option::get('sale', 'sale_locationpro_migrated', '') == 'Y') // CSaleLocation::isLocationProMigrated()
        {
            ...
            //TODO -- What is this: $LOCATION_FILE_MAP
