...
<?else:?>
	...
	<div id="sls-<?=$arResult['RANDOM_TAG']?>" class="bx-slst<?if($arResult['ADMIN_MODE']):?> bx-admin-mode<?endif?>">
		...
		<?if(is_array($arResult['TRUNK_NAMES']) && !empty($arResult['TRUNK_NAMES'])):?>
			<div class="bx-ui-sls-tree-trunk col-form-label">
		...
		<script type="text/html" data-template-id="bx-ui-slst-selector-scope">
			...
			<div class="dropdown-block form-control bx-ui-slst-input-block<?=($arParams['DISABLE_KEYBOARD_INPUT'] == 'Y' ? ' disabled-keyboard' : '')?>">
				...
				<div class="bx-ui-combobox-container" style="margin: 0px; padding: 0px; border: none; position: relative;">
					<?if($arParams['DISABLE_KEYBOARD_INPUT'] == 'Y'):?>
						<div class="bx-ui-combobox-fake bx-combobox-fake-as-input form-control">
				...
				<div class="bx-ui-combobox-dropdown select2-dropdown" data-bx-ui-id="combobox-dropdown">
