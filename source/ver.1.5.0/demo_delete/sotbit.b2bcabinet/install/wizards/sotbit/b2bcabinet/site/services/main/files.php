...
COption::SetOptionString("sotbit.b2bcabinet",'TEL',$wizard->GetVar("siteTelephone"));
COption::SetOptionString("sotbit.b2bcabinet",'COPYRIGHT',$wizard->GetVar("siteCopy"));
COption::SetOptionString("sotbit.b2bcabinet",'EMAIL',$wizard->GetVar("shopEmail"));

COption::SetOptionString("sotbit.b2bcabinet",'URL_CART',WIZARD_SITE_DIR.'personal/cart/');
COption::SetOptionString("sotbit.b2bcabinet",'URL_ORDER',WIZARD_SITE_DIR.'personal/order/make/');
COption::SetOptionString("sotbit.b2bcabinet",'URL_PERSONAL',WIZARD_SITE_DIR.'personal/');
COption::SetOptionString("sotbit.b2bcabinet",'URL_PAYMENT',WIZARD_SITE_DIR.'personal/order/payment/');
COption::SetOptionString("sotbit.b2bcabinet",'URL_PAGE_ORDER',WIZARD_SITE_DIR.'personal/order/');
//COption::SetOptionString("sotbit.b2bcabinet",'TABLE_SIZE_URL',WIZARD_SITE_DIR.'clients/table_sizes/#table');
COption::SetOptionString("sotbit.b2bcabinet", 'DETAIL_TEXT_INCLUDE', GetMessage('DETAIL_TEXT_INCLUDE', array('#SITE_DIR#' => WIZARD_SITE_DIR)));
...
if(COption::GetOptionString("sotbit.b2bcabinet", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
	return;
...
$methodInstall = $wizard->GetVar("method_install");
//    $filePath = $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/sotbit.b2bcabinet/install/wizards/sotbit/b2bcabinet/site/public/ru/";
