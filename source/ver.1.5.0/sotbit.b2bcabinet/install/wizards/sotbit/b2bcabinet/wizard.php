...
class SiteInstallParam extends CWizardStep
{
    ...
    {
        $wizard =& $this->GetWizard();
        $wizard->solutionName = "sotbit.b2bcabinet";
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
    function InitStep()
    {
        ...
        $siteID = $wizard->GetVar("wizSiteID");
        $isWizardInstalled = COption::GetOptionString("sotbit.b2bcabinet", "wizard_installed", "N", $siteID) == "Y";

        $wizard->SetDefaultVars(Array(
            "siteLogo" => file_exists(WIZARD_SITE_PATH."include/logo.png") ? WIZARD_SITE_DIR."include/logo.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/sotbit/b2bcabinet/site/templates/b2bcabinet/assets/images/B2B_logo.png"),
            "siteLogoRetina" => file_exists(WIZARD_SITE_PATH."include/logo.png") ? WIZARD_SITE_DIR."include/logo.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/sotbit/b2bcabinet/site/templates/b2bcabinet/assets/images/B2B_logo.png"),
            "siteLogoMobile" => file_exists(WIZARD_SITE_PATH."include/logo.png") ? WIZARD_SITE_DIR."include/logo.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/sotbit/b2bcabinet/site/templates/b2bcabinet/assets/images/B2B_logo.png"),
            "siteLogoMobileRetina" => file_exists(WIZARD_SITE_PATH."include/logo.png") ? WIZARD_SITE_DIR."include/logo.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/sotbit/b2bcabinet/site/templates/b2bcabinet/assets/images/B2B_logo.png"),
        ));
                ...
                if (preg_match("/^[0-9()+\-\s]+$/",$dataCollection['Phone']))
                {
                    ...
                    $options = array(
                        'http' => array(
                            ...
                            'content' => \Bitrix\Main\Web\Json::encode($request)
                        )
                    );
